...
{
    public partial class Form_Create_AL : Form
    {
        public Form_Create_AL()
        {
            InitializeComponent();
        }
        ...
        private void Form_Create_AL_Load(object sender, EventArgs e)
        {
            try
            {
        ...
        {
            if(txt_cont.Text == "+351" && txt_morada.Text == "" && txt_nome.Text == "" && txt_pass1.Text == "" && txt_pass2.Text == "" && txt_turma.Text == "" && txt_user.Text == "" && dtp_.Value == System.DateTime.Now && cbb_tipo.Text == "")
            {
                this.Close();
            }
            else
