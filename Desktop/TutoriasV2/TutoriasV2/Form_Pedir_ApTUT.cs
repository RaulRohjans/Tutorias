...
{
    public partial class Form_Pedir_ApTUT : Form
    {
        public Form_Pedir_ApTUT()
        {
            InitializeComponent();
        }
        ...
        private void Form_Pedir_ApTUT_Load(object sender, EventArgs e)
        {
            try
            {
        ...
        {
            if (txt_desc.Text == "" && txt_local.Text == "" && cbb_al.Text == "" && dtp_.Value == System.DateTime.Now && cbb_disc.Text == "")
            {
                this.Close();
            }
            else
                ...
                if (txt_local.Text != "")
                {
                    if (cbb_disc.Text != "")
                    {
                        if (cbb_al.Text != "")
                        {
                            ...
                            {
                                if (apoios[i].TutorID == cbb_al.Text && dtp_.Value == apoios[i].ReqDate)
                                {
                            ...
                            {
                                ep_.SetError(cbb_al, "Esse aluno não se encontra disponivel nesse dia!");
                            }
                        }
                        else
                        {
                            ep_.SetError(cbb_al, "Por favor selecione uma opção!");
                        }
                    }
                    else
                    {
