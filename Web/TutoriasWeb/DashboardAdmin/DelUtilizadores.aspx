<%@ Page Language="C#" AutoEventWireup="true" CodeFile="DelUtilizadores.aspx.cs" Inherits="DashboardAdmin_Utilizadores" %>
...
<head runat="server">
    ...
    <title>Eliminar Utilizadores - Tutorias</title>
    ...
    <div id="right-panel" class="right-panel">
        ...
        <div class="content mt-3">
            <div class="animated fadeIn">
                <div class="card">
                    <div class="card-header">Eliminar Aluno</div>
                    <div class="card-body card-block">
                        <form runat="server">
                            ...
                            <asp:Button ID="btn_eliminar" class="btn btn-success" runat="server" Text="Eliminar Utilizador" OnClick="btn_eliminar_Click" />
