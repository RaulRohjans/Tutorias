<%@ Page Language="C#" AutoEventWireup="true" CodeFile="AprovUtilizadores.aspx.cs" Inherits="DashboardAdmin_Utilizadores" %>
...
<head runat="server">
    ...
    <title>Aprovar Utilizadores - Tutorias</title>
...
<body>
    ...
    <div id="right-panel" class="right-panel">
        ...
        <form runat="server" method="post" action="UpAprovados.aspx">
            <br />
            <asp:Button ID="btn_atualizar" class="btn btn-success" runat="server" Text="Atualizar Lista" OnClick="btn_atualizar_Click" />
            <input id="Button1" class="btn btn-success" type="submit" value="Aprovar Pedidos" />

        <div class="card">
            <div class="card-header">
                <strong class="card-title">Aprovar Aluno/Tutor</strong>
            </div>
            <div class="card-body">
