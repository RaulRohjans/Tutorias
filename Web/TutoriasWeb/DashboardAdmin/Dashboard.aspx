                    ...
                    <div class="card-body">
                        <div class="stat-widget-one">
                            ...
                            <div class="stat-content dib">
                                <div class="stat-text">Total de Utilizadores</div>
                                <div class="stat-digit" id="TotalUtilizadores" runat="server"></div>
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div class="card">
                    <div class="card-body">
                        <div class="stat-widget-one">
                            ...
                            <div class="stat-content dib">
                                <div class="stat-text">Total de Apoios</div>
                                <div class="stat-digit" id="TotalApoios" runat="server"></div>
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div class="card">
                    <div class="card-body">
                        <div class="stat-widget-one">
                            <div class="stat-icon dib"><i class="ti-user text-primary border-primary"></i></div>
                            <div class="stat-content dib">
                                <div class="stat-text">Alunos por Aprovar</div>
                                <div class="stat-digit" id="UtilizadoresPorAprovar" runat="server"></div>
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div class="card">
                    <div class="card-body">
                        <div class="stat-widget-one">
                            <div class="stat-icon dib"><i class="ti-layout-grid2 text-warning border-warning"></i></div>
                            <div class="stat-content dib">
                                <div class="stat-text">Apoios por Aprovar</div>
                                <div class="stat-digit" id="ApoiosPorAprovar" runat="server"></div>
                            </div>
                        </div>
                    </div>
                </div>
