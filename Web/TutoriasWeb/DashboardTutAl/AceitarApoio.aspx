<%@ Page Language="C#" AutoEventWireup="true" CodeFile="AceitarApoio.aspx.cs" Inherits="DashboardAdmin_Utilizadores" %>
...
<head runat="server">
    ...
    <title>Aceitar Apoios - Tutorias</title>
...
<body>
                ...
                <ul class="nav navbar-nav">
                    ...
                    <li class="menu-item-has-children dropdown">
                        ...
                        <ul class="sub-menu children dropdown-menu">
                            ...
                            <li><i class="menu-icon fa fa-info-circle active"></i><a href="AceitarApoio.aspx">Aceitar</a></li>
                        </ul>
                    </li>
    ...
    <div id="right-panel" class="right-panel">
        ...
        <form runat="server" method="post" action="UpAprovAp.aspx">
            <br />
            <asp:Button ID="btn_atualizar" class="btn btn-success" runat="server" Text="Atualizar Lista" OnClick="btn_atualizar_Click" />
            <input id="Button1" class="btn btn-success" type="submit" value="Aceitar Pedidos" />
