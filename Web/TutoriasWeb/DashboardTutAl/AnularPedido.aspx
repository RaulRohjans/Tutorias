<%@ Page Language="C#" AutoEventWireup="true" CodeFile="AnularPedido.aspx.cs" Inherits="DashboardAdmin_Utilizadores" %>
...
<head runat="server">
    ...
    <title>Anular Pedidos - Tutorias</title>
...
<body>
                ...
                <ul class="nav navbar-nav">
                    ...
                    <li class="menu-item-has-children dropdown">
                        ...
                        <ul class="sub-menu children dropdown-menu">
                            ...
                            <li><i class="menu-icon fa fa-info-circle active"></i><a href="AnularPedido.aspx">Anular</a></li>
    ...
    <div id="right-panel" class="right-panel">
                ...
                <div class="page-header float-right">
                    <div class="page-title">
                        <ol class="breadcrumb text-right">
                            ...
                            <li class="active">Anular Pedidos</li>
                        </ol>
                    </div>
                </div>
            </div>
        ...
        <form runat="server" method="post" action="UpAnular.aspx">
            <br />
            <asp:Button ID="btn_atualizar" class="btn btn-success" runat="server" Text="Atualizar Lista" OnClick="btn_atualizar_Click" />
            <input id="Button1" class="btn btn-success" type="submit" value="Anular Pedidos" />
