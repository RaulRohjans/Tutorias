...
/// <summary>
/// Summary description for TutoriasService
/// </summary>
[WebService(Namespace = "http://tempuri.org/")]
[WebServiceBinding(ConformsTo = WsiProfiles.BasicProfile1_1)]
// To allow this Web Service to be called from script, using ASP.NET AJAX, uncomment the following line. 
// [System.Web.Script.Services.ScriptService]
public class TutoriasService : System.Web.Services.WebService
{
    SqlConnection db = new SqlConnection(@"Server =.\SQLEXPRESS; Database = TutoriasDB; Trusted_Connection=True;");
    SqlCommand ocm;
    SqlDataReader reader;

    /*public TutoriasService()
    {
    ...
    public TutoriasService(List<Disciplinas> disciplinas, List<Alunos> alunos, List<Apoios> apoios)
    {
        //Disciplinas
        Refresh(disciplinas);
